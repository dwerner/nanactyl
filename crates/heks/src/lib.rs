...
//! A handy ECS
//!
//! heks provides a high-performance, minimalist entity-component-system (ECS)
//! world. It is a library, not a framework. In place of an explicit "System"
//! abstraction, a `World`'s entities are easily queried from regular code.
//! Organize your application however you like!
//!
//! In order of importance, heks pursues:
//! - fast traversals
//! - a simple interface
...
#[cfg(feature = "macros")]
pub use heks_macros::{Bundle, DynamicBundleClone, Query};
#[cfg(feature = "macros")]
#[doc(hidden)]
pub use lazy_static;
#[doc(hidden)]
